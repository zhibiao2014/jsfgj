var msg1 = "你知道你的 Internet Explorer 浏览器已经过时了吗？";
var msg2 = "建议你升级到较新的版本，或是改用其他的浏览器，以获得更好的使用体验。下面是一份目前广受欢迎的浏览器列表.";
var msg3 = "只要点选图标，就可以连到各自的下载页面。";
...
function e(str) {
  ...
  _uld.style.position = "absolute";
  _uld.style.top = "130px";
  _uld.style.left = "-30px";
  ...
  _li1ds.float = _li2ds.float = _li3ds.float = _li4ds.float = _li5ds.float = "left";
